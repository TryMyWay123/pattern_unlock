...
display_win = False
pattern = []  # Empty list for password

# Function to generate a random password
def generate_password():
    return random.sample(range(1, 26), 7)  # Generate a list of 7 unique random numbers from 1 to 25

pattern = generate_password() # Generate the initial password
...
def generate_password_clicked(this):
    global pattern
    pattern = generate_password()
    
    #Add a draw in function for random display
    print(pattern)
    
generate_password_button_styles = {
    "hover_background_color": (200, 200, 200),
    "font_size": 10,
    "background_color": (210, 210, 210),
...
generate_password_button = Button(250, 40, 150, 20, "Generate Password", generate_password_button_styles)
...
while pen.is_running:
    ...
    reset_button.update()
    generate_password_button.update()
